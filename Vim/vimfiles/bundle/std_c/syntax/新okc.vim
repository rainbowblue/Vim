...
" hi def link cUserLabel	Label
  hi def link cUserLabel	UserLabel2
  hi def link cUserLabel2	UserLabel2
  hi def link cGotoLabel	UserLabel2
  hi def link cGoto		Statement
  ...
  hi def link cSpaceError	Error
  hi def link cSpecialError	Error
  hi def link cOperator	Operator
  hi def link cOperatorBold	OperatorBold
  hi def link cStructure	Structure
  hi def link cStorageClass	StorageClass
  hi def link cInclude	Include
  hi def link cPreProc	PreProc
  hi def link cDefine	Macro
  hi def link cDefined	PreCondit
  hi def link cIncluded	String
  hi def link cError		Error
  hi def link cStatement	Statement
  hi def link cPreCondit	PreCondit
  hi def link cPreConditIf	PreCondit
  ...
  hi def link cComment	omment
  hi def link cSpecial	SpecialChar
  hi def link cTodo		Todo
  hi def link cCppSkip	cCppOut
  hi def link cCppOut2	cCppOut
  hi def link cCppOut	Comment
  hi def link cMulti		Operator
  hi def link cMultiMG	Operator
  hi def link cFunction	Function
  hi def link cAnsiFunction	StdFunction
  hi def link cName		Name
  hi def link cBitField	Name
  hi def link cAnsiName	StdName
  "hi def link cBlock	BlockBraces
  hi def link cBraces	BlockBraces
  "hi def link cBraceError	Error
  hi def link cMC		MicroController
  hi def link cAnsiFuncPtr	AnsiFuncPtr
